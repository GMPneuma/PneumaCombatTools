...
try {
 ...
 await page.addScriptTag({type:'module',content:'import {registerEmp,chooseEmp,configureEmp} from "/scripts/emp.js"; Object.assign(window,{chooseEmp,configureEmp});registerEmp();window.loaded=true;'});
