...
export function registerTurnMarker(){
  ...
  game.settings!.register(M,"turnMarkerDistance",{name:"Indicator distance",hint:"Gap beyond the token edge, as a percentage of one grid square. Circuit paths extend from the center to this perimeter.",scope:"world",config:false,type:Number,default:8,range:{min:0,max:50,step:1},onChange:refreshTurnMarker});
