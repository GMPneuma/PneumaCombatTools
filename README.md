...
The 0.5.5 release passed build, regression and browser-fixture checks. Live Foundry multiplayer verification remains separate. Some effects still require GM adjudication; the guides distinguish those from automated behavior.
